...
import com.nhuallpa.person.infrastructure.exception.ConflictException;
import com.nhuallpa.person.infrastructure.exception.GeneralException;
...
public class PersonServiceImpl implements PersonService {
  ...
  public Person create(Person person) {
    ...
    Person personExist = this.personRepository.findByDocumentNumber(person.getDocumentNumber()).orElse(null);
    if (personExist != null) {
